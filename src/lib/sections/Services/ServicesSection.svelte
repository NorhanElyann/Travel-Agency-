...
<section class="py-16 text-center ">
	<div class="mb-2 text-sm font-bold tracking-wide text-[#5E6282] uppercase">Category</div>
	<h2 class="font-volkhov mb-10 text-3xl font-bold text-[#14183E] md:text-4xl">
